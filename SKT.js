var SKT = {
	"Augrek Brighthelm": {
		...
		attacks: [{
				...
				range: "Melee (5 ft)",
				description: "Or 7 (1d10+2) bludgeoning damage if used with two hands.",
			}, {
				name: "Heavy Crossbow",
				ability: 1,
	...
	"Ghelryn Foehammer": {
		...
		attacks: [{
				...
				range: "Melee (5 ft)",
				description: "Or 9(ldlO + 4) slashing damage if used with two hands.",
			},
		],
		traits: [{
				name: "Dwarven Resilience",
	...
	"Uthgardt Shaman": {
		...
		attacks: [{
				...
				damage: [1, 6, "piercing"],
				range: "Melee (5 ft)",
				description: "Or 6 (1d8 + 2) piercing damage if wielded with two hands.",
			}, {
				name: "Spear (Ranged)",
				ability: 1,
				damage: [1, 6, "piercing"],
	...
	"Yakfolk Priest": {
		...
		attacks: [{
				...
				damage: [2, 6, "bludgeoning"],
				range: "Melee (5 ft)",
				description: "Or 12 (2d8+3) bludgeoning damage if used with two hands.",
			}
		],
		traits: [{
				name: "Possession (Recharges after a rest",
